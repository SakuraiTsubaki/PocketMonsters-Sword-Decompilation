...
A complete, target-specific workspace for reproducible research, analysis, tooling, source reconstruction, and retained non-ROM work products related to **Pocket Monsters Sword**.

| Field | Value |
| --- | --- |
| Working target | Pocket Monsters Sword |
